	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"border":"1px solid #fff","boxShadow":"none","padding":"0 10%","alignItems":"center","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#BFD0CA","borderWidth":"0 0 90px","width":"100%","position":"absolute","height":"140px","zIndex":"1002"}'>
			...
			<div :style='{"position":"absolute","top":"70px","left":"10%","display":"block","zIndex":"999"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"30px","color":"#000","float":"left","fontWeight":"bold"}'>公交智能化系统</span>
			</div>
			...
			<div id="search" class="search" :style='{"margin":"0 10px","flexWrap":"wrap","background":"#fff","display":"none","height":"auto"}'>
				...
				<div :style='{"margin":"0"}' class="btn" v-if="queryIndex==0">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","width":"auto","lineHeight":"44px","fontSize":"14px","height":"44px"}' type="primary" @click="search('gongjiaoxianlu')">
...
export default {
    data() {
		...
		gongjiaoxianluxianlu: '',
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-keyboard","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-time","buttons":["新增","查看","修改","删除"],"menu":"线路","menuJump":"列表","tableName":"xianlu"}],"menu":"线路管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-pic","buttons":["新增","查看","修改","删除"],"menu":"车次","menuJump":"列表","tableName":"checi"}],"menu":"车次管理"},{"child":[{"allButtons":["新增","查看","修改","删除","公交车次","公交线路","查看评论"],"appFrontIcon":"cuIcon-pay","buttons":["新增","查看","修改","删除","查看评论","公交车次","公交线路"],"menu":"公交线路","menuJump":"列表","tableName":"gongjiaoxianlu"}],"menu":"公交线路管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-pic","buttons":["新增","查看","修改","删除"],"menu":"公交站点","menuJump":"列表","tableName":"gongjiaozhandian"}],"menu":"公交站点管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-shop","buttons":["新增","查看","修改","删除"],"menu":"公交信息","menuJump":"列表","tableName":"gongjiaoxinxi"}],"menu":"公交信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-camera","buttons":["新增","查看","修改","删除"],"menu":"周边服务","menuJump":"列表","tableName":"zhoubianfuwu"}],"menu":"周边服务管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-paint","buttons":["新增","查看","修改","删除"],"menu":"公交动态","menuJump":"列表","tableName":"gongjiaodongtai"}],"menu":"公交动态管理"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-rank","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-full","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-link","buttons":["查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","公交车次","公交线路","查看评论"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看"],"menu":"公交线路列表","menuJump":"列表","tableName":"gongjiaoxianlu"}],"menu":"公交线路模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-wenzi","buttons":["查看"],"menu":"公交站点列表","menuJump":"列表","tableName":"gongjiaozhandian"}],"menu":"公交站点模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["查看"],"menu":"公交信息列表","menuJump":"列表","tableName":"gongjiaoxinxi"}],"menu":"公交信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-medal","buttons":["查看"],"menu":"周边服务列表","menuJump":"列表","tableName":"zhoubianfuwu"}],"menu":"周边服务模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-favor","buttons":["查看"],"menu":"我的收藏","menuJump":"1","tableName":"storeup"}],"menu":"我的收藏管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","公交车次","公交线路","查看评论"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看"],"menu":"公交线路列表","menuJump":"列表","tableName":"gongjiaoxianlu"}],"menu":"公交线路模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-wenzi","buttons":["查看"],"menu":"公交站点列表","menuJump":"列表","tableName":"gongjiaozhandian"}],"menu":"公交站点模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["查看"],"menu":"公交信息列表","menuJump":"列表","tableName":"gongjiaoxinxi"}],"menu":"公交信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-medal","buttons":["查看"],"menu":"周边服务列表","menuJump":"列表","tableName":"zhoubianfuwu"}],"menu":"周边服务模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
