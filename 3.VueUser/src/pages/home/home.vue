...
<div class="home-preview" :style='{"width":"100%","margin":"0 auto","flexDirection":"column","background":"#fff","display":"flex"}'>
	...
	<div id="search" class="search animate__animated" :style='{"padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"30px auto","overflow":"hidden","borderRadius":"30px","flexWrap":"wrap","background":"#fff","display":"flex","width":"80%","height":"auto","order":"1"}'>
		...
		<div :style='{"width":"calc(100% - 200px)","margin":"0"}' class="input" v-if="queryIndex==0">
			<el-input v-model="gongjiaoxianluxianlu" placeholder="线路"></el-input>
		</div>
		<div :style='{"margin":"0"}' class="btn" v-if="queryIndex==0">
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0","color":"#000","right":"0","outline":"none","borderRadius":"30px","background":"#fff","width":"100px","lineHeight":"50px","fontSize":"0","position":"absolute","height":"50px"}' type="primary" @click="search('gongjiaoxianlu')">
...
<!-- 商品推荐 -->
<div id="animate_recommendgongjiaoxianlu" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>公交线路推荐</span>
	</div>
	...
	<div v-if="gongjiaoxianluRecommend.length" class="list list12 index-pv1 list12gongjiaoxianlu" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="tab" :style='{"padding":"0","boxShadow":" 0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0 0 0 20px","flexWrap":"wrap","background":"#FFFBFB","display":"flex","width":"170px","height":"auto","order":"2"}'>
	    <template v-for="item,index in recommendList12gongjiaoxianlu">
		<div v-if="index < 6" @click="recommendIndexClick12(index + 1, 'gongjiaoxianlu')" class="item" :class="index + 1 == recommendIndex12gongjiaoxianlu ? 'active' : ''">
			...
			<div :style='{"color":"inherit","fontSize":"14px"}'>{{item[recommendColumn12gongjiaoxianlu]}}</div>
		</div>
		</template>
		<div class="more" @click="moreBtn('gongjiaoxianlu')">
	  ...
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in gongjiaoxianluRecommend" :key="index" @click="toDetail('gongjiaoxianluDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.gongjiaochehao}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('gongjiaoxianlu')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
...
<!-- 商品推荐 -->
<div id="animate_recommendgongjiaozhandian" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>公交站点推荐</span>
	</div>
	...
	<div v-if="gongjiaozhandianRecommend.length" class="list list12 index-pv1 list12gongjiaozhandian" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in gongjiaozhandianRecommend" :key="index" @click="toDetail('gongjiaozhandianDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.zhandianzhaopian)" :src="item.zhandianzhaopian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.zhandianzhaopian?item.zhandianzhaopian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.zhandianmingcheng}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('gongjiaozhandian')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
		<span :style='{"color":"#9E9E9E","fontSize":"12px"}'>查看更多</span>
		<i :style='{"color":"#f5f5f5","fontSize":"12px","display":"none"}' class="icon iconfont icon-gengduo1"></i>
	</div>
...
<!-- 特价商品 -->
<div id="animate_listgongjiaoxianlu" class="lists animate__animated" :style='{"padding":"0 0 100px","margin":"0 0 0","background":"url(http://codegen.caihongy.cn/20231122/7eef55d4e07f4b0598a9e072cb72541b.png)","backgroundSize":"cover","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","order":"7"}'>
	...
	<div class="title" :style='{"width":"30%","margin":"30px 10%","lineHeight":"54px","textAlign":"left","background":"none"}'>
	  <span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>公交线路展示</span>
	</div>
	...
	<div class="list list15 index-pv1" :style='{"padding":"0","margin":"0 auto","alignItems":"center","display":"flex","width":"80%","justifyContent":"center","height":"auto"}'>
	  <div :style='{"width":"32%","height":"auto"}' class="list left">
		<template v-if="gongjiaoxianluList.length">
	    <template v-for="item,index in gongjiaoxianluList">
		<div v-if="index == 0" @click="toDetail('gongjiaoxianluDetail', item)" :style='{"width":"100%","margin":"0 0 30px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.gongjiaochehao}}</div>
	      </div>
	    </div>
		</template>
		</template>
		<template v-if="gongjiaoxianluList.length > 1">
		<template v-for="item,index in gongjiaoxianluList">
	    <div v-if="index == 1" @click="toDetail('gongjiaoxianluDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.gongjiaochehao}}</div>
	  ...
	  <div :style='{"width":"32%","margin":"0 2%","height":"auto"}' class="list center">
		<template v-if="gongjiaoxianluList.length > 2">
		<template v-for="item,index in gongjiaoxianluList">
	    <div v-if="index == 2" @click="toDetail('gongjiaoxianluDetail', item)" :style='{"width":"100%","margin":"0 0 15px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.gongjiaochehao}}</div>
	    ...
	    <div :style='{"margin":"0 0 15px","alignItems":"center","background":"#fff","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"200px"}' class="box2">
	      <div :style='{"fontSize":"24px","lineHeight":"54px","color":"#000","fontWeight":"bold"}' class="title">{{gongjiaoxianluList[2].gongjiaochehao}}</div>
	      <div :style='{"color":"#4D4D4D","fontSize":"16px","lineHeight":"1.5"}' class="desc">{{gongjiaoxianluList[2].tujingzhandian}}</div>
	    </div>
		<template v-if="gongjiaoxianluList.length > 3">
		<template v-for="item,index in gongjiaoxianluList">
	    <div v-if="index == 3" @click="toDetail('gongjiaoxianluDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box3 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.gongjiaochehao}}</div>
	  ...
	  <div :style='{"width":"32%","height":"auto"}' class="list right">
	    <template v-if="gongjiaoxianluList.length > 4">
	    <template v-for="item,index in gongjiaoxianluList">
	    <div v-if="index == 4" @click="toDetail('gongjiaoxianluDetail', item)" :style='{"width":"100%","margin":"0 0 30px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.gongjiaochehao}}</div>
		...
		<template v-if="gongjiaoxianluList.length > 5">
		<template v-for="item,index in gongjiaoxianluList">
	    <div v-if="index == 5" @click="toDetail('gongjiaoxianluDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.luxiantupian)" :src="item.luxiantupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.luxiantupian?item.luxiantupian.split(',')[0]:'')" alt="" />
	      <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.gongjiaochehao}}</div>
	...
	<div @click="moreBtn('gongjiaoxianlu')" :style='{"border":"1px solid #000","margin":"10px auto","top":"30px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"10%"}'>
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryIndex: 0,
        gongjiaoxianluxianlu: '',
        newsList: [],
        gongjiaoxianluRecommend: [],
        gongjiaozhandianRecommend: [],

        gongjiaoxianluList: [],

		newListSwiper13news: null,

		recommendIndex12gongjiaoxianlu: 0,
		recommendList12gongjiaoxianlu: [],
		recommendColumn12gongjiaoxianlu: '',
    ...
    created() {
		...
		this.getList();
		this.gongjiaoxianluRecommendCate()
    },
	mounted() {
    ...
    methods: {
		...
		gongjiaoxianluRecommendCate(){
			this.$http.get('xianlu/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12gongjiaoxianlu = res.data.data.list
			  }
			});
			this.recommendColumn12gongjiaoxianlu = 'xianlu'
		},
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendgongjiaoxianlu',css:'animate__'},
				{id:'animate_listgongjiaoxianlu',css:'animate__'},
				{id:'animate_recommendgongjiaozhandian',css:'animate__'},
      ...
      search(tablename) {
        if (this.queryIndex == 0 && this.gongjiaoxianluxianlu) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.gongjiaoxianluxianlu}});
        }
      },
		getNewsList() {
			let data = {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "gongjiaoxianlu/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "gongjiaoxianlu/autoSort2";
          }
			data = {
				page: 1,
				limit: 6,
			}
			if(this.recommendIndex12gongjiaoxianlu != 0){
				data.xianlu = this.recommendList12gongjiaoxianlu[this.recommendIndex12gongjiaoxianlu - 1].xianlu
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.gongjiaoxianluRecommend = res.data.data.list;
          ...
          autoSortUrl = "gongjiaozhandian/autoSort";
			data = {
				page: 1,
				limit: 6,
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.gongjiaozhandianRecommend = res.data.data.list;
			...
			this.$http.get('gongjiaoxianlu/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.gongjiaoxianluList = res.data.data.list;
